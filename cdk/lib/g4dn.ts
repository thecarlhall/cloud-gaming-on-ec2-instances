...
export class G4DNStack extends BaseEc2Stack {
    ...
    protected getUserdata() {
        ...
        userData.addCommands(
            ...
            `Invoke-WebRequest -Uri "$Parsec" -OutFile $InstallationFilesFolder\\2_parsec-windows.exe`,
            ...
            `Invoke-WebRequest -Uri "$Steam" -OutFile $InstallationFilesFolder\\5_SteamSetup.exe`,
            `Invoke-WebRequest -Uri "$NvFBC" -OutFile $LocalTempPath\\NvFBCEnable.zip`,
            `Expand-Archive "$LocalTempPath\\NvFBCEnable.zip" -DestinationPath $InstallationFilesFolder\\6_NvFBCEnable`,
